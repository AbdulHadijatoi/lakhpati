        ...
        <div class="block-content block-content-full">
          <div class="row">
              ...
              <div class="form-group col-md-3 mb-4">
                  ...
                  <input type="number" class="form-control" id="total_second_winners" name="total_second_winners" required>
              </div>
              ...
              <div class="form-group col-md-3 mb-4">
                  ...
                  <input type="number" class="form-control" id="total_third_winners" name="total_third_winners" required>
              </div>
